#Phase 1: load and merge the training and testing sets
...
#Phase 2: select only the mean and standard deviation entries (from features.txt)
...
#Phase 3: rename the activities using the descriptive labels (from activity_labels.txt)
...
#Phase 7: create final output set with calculations
